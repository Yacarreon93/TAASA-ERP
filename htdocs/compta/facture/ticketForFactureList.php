...
llxHeader('',"Ticket",'Tickets a Facturar');
...
if ($resql)
{
    ...
    print_barre_liste("Tickets a Clientes".' '.($socid?' '.$soc->name:''),$page,$_SERVER["PHP_SELF"],$param,$sortfield,$sortorder,'',$num,$nbtotalofrecords,'title_accountancy.png');
