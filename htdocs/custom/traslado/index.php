...
if ($result)
{
    ...
    print_liste_field_titre($langs->trans("Traslado"),$_SERVER['PHP_SELF'],"u.login",$param,"","",$sortfield,$sortorder);
    print_liste_field_titre($langs->trans("Traslado"),$_SERVER['PHP_SELF'],"u.lastname",$param,"","",$sortfield,$sortorder);
    print_liste_field_titre($langs->trans("Traslado"),$_SERVER['PHP_SELF'],"u.firstname",$param,"","",$sortfield,$sortorder);
