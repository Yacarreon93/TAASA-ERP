...
abstract class CommonObject
{
   ...
   /**
    ...
    function showDisabledOptionals($extrafields, $mode='view', $params=null, $keyprefix='')
    {
		global $_POST, $conf, $langs;
    ...
    function showLockedOptionals($extrafields, $mode='view', $params=null, $keyprefix='')
    {
		global $_POST, $conf, $langs;
		...
		if (count($extrafields->attribute_label) > 0)
		{
			...
			foreach($extrafields->attribute_label as $key=>$label)
			{
				...
				else
				{
                    ...
                    $input_attrs = 'readonly disabled style="background:#ddd;cursor:not-allowed"';
